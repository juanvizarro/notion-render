...
import type { NavigationLink } from 'interfaces/site-config.interface'
import type {
  NavigationStyle,
...
// general site config
export const name = getSiteConfig<string>('name')
export const author = getSiteConfig<string>('author')
export const domain = getSiteConfig<string>('domain')
export const description = getSiteConfig<string>('description', 'Notion Blog')
export const language = getSiteConfig<string>('language', 'en')
